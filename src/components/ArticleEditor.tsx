    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <textarea
          id="overview"
          rows={4}
          value={editedArticle.content_blocks.overview || ''}
      ...
      <div>
        <label htmlFor="mechanisms" className="block text-sm font-medium text-gray-700">
          Mechanisms
        </label>
        <textarea
          id="mechanisms"
          rows={4}
          value={editedArticle.content_blocks.mechanisms || ''}
          onChange={(e) => handleContentChange('mechanisms', e.target.value)}
          className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
        />
      </div>

      <div>
        <label htmlFor="practical_takeaways" className="block text-sm font-medium text-gray-700">
          Practical Takeaways
        </label>
        <textarea
          id="practical_takeaways"
          rows={4}
          value={editedArticle.content_blocks.practical_takeaways || ''}
          onChange={(e) => handleContentChange('practical_takeaways', e.target.value)}
          className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
        />
      </div>
